...
type CrossWeaponCrawler struct {
	ICrawler
}

func NewCrossWeaponCrawler() ICrawler {
	return &CrossWeaponCrawler{
		ICrawler: NewAbstractCrawler(config.CROSS_WEAPON_PAGE, model.CROSS_WEAPON_UNIT_TYPE),
	}
}

func (c *CrossWeaponCrawler) JobName() string {
	return "CrossWeaponCrawlJob"
}

func (a *CrossWeaponCrawler) Crawl() (model.CrawlResultJSON, error) {
...
func (a *CrossWeaponCrawler) getWeaponInfo(s *goquery.Selection) model.UnitInfoJSON {
