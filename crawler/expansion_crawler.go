...
func (a *ExpansionCrawler) Crawl() (model.CrawlResultJSON, error) {
...
func (a *ExpansionCrawler) IsTargetSection(s *goquery.Selection) bool {
	return s.Text() != ""
}

func (a *ExpansionCrawler) GetUnitInfo(s *goquery.Selection) model.UnitInfoJSON {
